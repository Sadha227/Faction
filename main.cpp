...
{
	if (a < 0 && b < 0) { _a = a; _b = b; return; } 
    else if (b < 0) { _a = -a; _b = -b; return; } 
    _a = a; _b = b;
}
...
bool Fraction::operator==(Fraction obj)
{
	...
	Fraction tmp2 = obj;
	tmp2.reduction();
	if (tmp1._b == tmp2._b && tmp1._a == tmp2._a) { return true; }
	else { return false; }
}
...
bool Fraction::operator>(Fraction obj)
{
	...
	tmp1._a = a1;
	tmp2._a = a2;
	if (tmp1._a > tmp2._a) { return true; }
	else { return false; }
}
